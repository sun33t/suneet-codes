...
export const DesktopNavigation = memo(
  ({ routeNames, ...rest }: DesktopNavigationProps) => {
    return (
      <nav {...rest}>
        <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium shadow-lg ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10">

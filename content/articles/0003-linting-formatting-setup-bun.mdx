...
<SeriesSection
  seriesDescription="This atirlce is part of a series which covers the setup of automated linting, formatting, and conventional commits in various JavaScript runtimes using git hooks."
  seriesEntries={[
    {
      id: 1,

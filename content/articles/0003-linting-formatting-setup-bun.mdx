...
In the [first article](/articles/linting-formatting-setup) we implented the workflow within a node project and in the [second](/articles/linting-formatting-setup-deno), we used deno. This time its Bun's turn!

...
description: This is an automated workflow for linting and formatting staged files during the git life-cycle and for using an interactive terminal for composing commit messages with conventional commit syntax.
coverImage: space

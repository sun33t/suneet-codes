...
It's silly but it's so much fun! What every developer needs is a bit of levity to break up the day! Enter the _git commit confetti cannon_! Marvel in wonder as your mac (sorry linux and windows users) rewards your efforts with a virtual pat on the back in the form of confetti and applause! You're awesome!!!
...
What do you mean you don't have Raycast installed already? It's amazing, let's do that by downloading it [here](https://www.raycast.com/) or if you use homebrew by issuing `brew install --cask raycast` from the terminal.
...
This automation uses the 1-Click Confetti Raycast extension created by [Pedro Duarte](https://github.com/peduarte). Check out his other Raycast extensions [here](https://www.raycast.com/peduarte).
